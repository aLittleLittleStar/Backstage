...
$(function() {
	...
	function dropSwift(dom, drop) {
		...
		$(".first").on("click", '#getReady', function() {
			$(window.parent.document).find("#changeItem").attr("src","child/get_ready.html");  
		})
		$(".first").on("click", '#search', function() {
			$(window.parent.document).find("#changeItem").attr("src","child/search.html");  
		})
		$(".first").on("click", '#userList', function() {
			$(window.parent.document).find("#changeItem").attr("src","child/user_list.html");  
		})

		$(".first").on("click", '#installDetail', function() {
			$(window.parent.document).find("#changeItem").attr("src","child/install_detail.html");  
		})
