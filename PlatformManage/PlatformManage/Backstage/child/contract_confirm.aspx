<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contract_confirm.aspx.cs" Inherits="PlatformManage.Backstage.child.contract_confirm" %>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="SubmitButton" CssClass="btn btn-primary" runat="server" CausesValidation="false" CommandName="" OnClick="SubmitButton_Click" Text="确认合同" />
                    </div>
                </div>
            </div>
        </div>
