<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wardrobe.aspx.cs" Inherits="PlatformManage.Backstage.child.wardrobe" %>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="owner" name="owner" value="阎良" disabled runat="server"/>
                            </div>
                        </div>
                        <div class="form-group">
